...
This repo provides multi-task baseline of [OffPyMARL](https://github.com/zzq-bot/offline-marl-framework-offpymarl), which provides unofficial and benchmarked PyTorch implementations for selected Offline MARL algorithms, including:
